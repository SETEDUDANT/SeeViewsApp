...
//        DrawableCompat.setTint(d, mIconTextColor);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) view.findViewById(R.id.camera_toolbar);
        ...
        view.findViewById(R.id.camera_toolbar_wrapper).setPadding(0, statusBarHeight, 0, 0);
        View controlLandWrapper = view.findViewById(R.id.controlsFrameLandWrapper);
        if (controlLandWrapper != null)
            controlLandWrapper.setPadding(0, statusBarHeight, 0, 0);
...
//        view.findViewById(R.id.controlsFrame).setBackgroundColor(primaryColor); //set in layouts
...
//                            .negativeText(R.string.mcm_cancel)
