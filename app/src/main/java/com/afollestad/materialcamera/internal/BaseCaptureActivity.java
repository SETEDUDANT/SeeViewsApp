...
import com.afollestad.materialcamera.internal.fragments.BaseCameraFragment;
import com.afollestad.materialcamera.internal.fragments.BaseGalleryFragment;
import com.afollestad.materialcamera.internal.fragments.PlaybackVideoFragment;
import com.afollestad.materialcamera.internal.fragments.StillshotPreviewFragment;
 ...
 */
public abstract class BaseCaptureActivity extends SeeviewActivity implements BaseCaptureInterface {
...
//        ViewGroup sceneRoot = (ViewGroup) findViewById(R.id.camera_coordinator);
//        BlurView blurView = (BlurView) findViewById(R.id.camera_toolbar_wrapper);
//
//        setupBlurForToolbar(sceneRoot, blurView);
//        findViewById(R.id.camera_toolbar_wrapper).setPadding(0, ActivityUtils.getStatusBarHeight(this), 0, 0);
    }
    ...
    @Override
    public final void useMedia(String uri, String comment) {
        if (uri != null) {
            setResult(Activity.RESULT_OK, getIntent()
                    .putExtra(MaterialCamera.EXTRA_COMMENT, comment)
    ...
    public String question() {
        return getIntent().getStringExtra(CameraIntentKey.QUESTION);
    }
}