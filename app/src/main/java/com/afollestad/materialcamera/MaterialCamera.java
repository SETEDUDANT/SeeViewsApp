...
public class MaterialCamera {
    ...
    public MaterialCamera iconStillshot(@DrawableRes int iconRes){
        mIconStillshot = iconRes;
        return this;
    }
    ...
    public MaterialCamera additionalCommentQuestion(String question) {
        this.question = question;
        Log.d(TAG, "additionalCommentQuestion: " + question);
        return this;
    }
    ...
    public Intent getIntent() {
        ...
        if (mIconStillshot != 0)
            intent.putExtra(CameraIntentKey.ICON_STILL_SHOT, mIconStillshot);
        if (mIconRecord != 0)
        ...
        if (question != null)
            intent.putExtra(CameraIntentKey.QUESTION, question);

        Log.d(TAG, "getIntent: " + intent.hasExtra(CameraIntentKey.QUESTION));
